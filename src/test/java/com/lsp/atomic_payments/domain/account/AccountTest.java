...
class AccountTest {
  ...
  private static final Money MONEY_100EUR =
      new Money(BigDecimal.valueOf(100), Currency.getInstance("EUR"));
  private static final Money MONEY_30EUR =
      new Money(BigDecimal.valueOf(30), Currency.getInstance("EUR"));
  private static final Money MONEY_70EUR =
      new Money(BigDecimal.valueOf(70), Currency.getInstance("EUR"));
  private static final Money MONEY_50EUR =
      new Money(BigDecimal.valueOf(50), Currency.getInstance("EUR"));
  private static final Money MONEY_150EUR =
  ...
  void isActive_returnsTrue_whenStatusIsActive() {
    Account account =
        new Account(AccountId.newId(), OWNER, MONEY_100EUR, AccountStatus.ACTIVE, VERSION, NOW);
  ...
  void isActive_returnsFalse_whenStatusIsNotActive() {
    Account account =
        new Account(AccountId.newId(), OWNER, MONEY_100EUR, AccountStatus.SUSPENDED, VERSION, NOW);
